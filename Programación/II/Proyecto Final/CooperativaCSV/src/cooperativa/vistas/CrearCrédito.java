 ...
 * @author marin
 */
public class CrearCrédito extends javax.swing.JPanel {
    ...
    public CrearCrédito() {
        ...
        try {
            origen = new CSVReader(new FileReader("creditos.csv"));
            String[] linea = null;
            try {
                ...
                Logger.getLogger(CrearCrédito.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        for (Crédito tipo : Créditos) {
            if(lastId < tipo.getIdCredito()) {
                lastId = tipo.getIdCredito();
            }
        }
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if(fechaVal.getText().equals("") || comboIdMovimiento.getModel().getSelectedItem().equals("")) {
            ...
            Créditos.add(new Crédito(lastId + 1, fechaVal.getText(), Integer.parseInt(idMovimiento), statusId));
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "El crédito se ha guardado exitosamente");
