 ...
 * @author marin
 */
public class VerMovimientosCrédito extends javax.swing.JPanel {
     ...
     */
    public VerMovimientosCrédito() {
        try {
            initComponents();
            
            CSVReader origen = new CSVReader(new FileReader("mvxcreditos.csv"));
            String[] linea = null;
            ...
            for (int i = 0; i < MovimientosCrédito.size(); i++){
                
                list[i][0] = String.valueOf(MovimientosCrédito.get(i).getIdMovxCredito());
                list[i][1] = String.valueOf(MovimientosCrédito.get(i).getIdMovimiento());
                list[i][2] = String.valueOf(MovimientosCrédito.get(i).getIdCredito());
                switch(MovimientosCrédito.get(i).getStatus()) {
                    case "0":
                        list[i][3] = "Inactivo (0)";
                        break;
                    case "1":
            ...
            Logger.getLogger(VerMovimientosCrédito.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        Título.setText("Movimientos de crédito");
        ...
        BtnCrear.setText("Crear movimiento de crédito");
        ...
        BtnEliminar.setText("Eliminar movimiento de crédito");
    ...
    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
        if(this.idColumna == -1) {
            ...
            MovimientosCrédito.remove(idColumna);
            try {
                ...
                JOptionPane.showMessageDialog(null, "El movimiento de crédito se ha eliminado exitosamente");
    ...
    private void BtnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCrearActionPerformed
        refrescaVista(new CrearMovimientoCrédito(), "", "");
