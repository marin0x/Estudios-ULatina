 ...
 * @author marin
 */
public class CrearMovimientoCrédito extends javax.swing.JPanel {
    
    private int lastId = -1;
    private ArrayList<MovimientoCrédito> MovimientosCrédito = new ArrayList();
    
    /**
     * Creates new form Inicio
     */
    public CrearMovimientoCrédito() {
        
        initComponents();
        
        CSVReader origen, origenMovimiento, origenCrédito;
        
        try {
            origen = new CSVReader(new FileReader("mvxcreditos.csv"));
            String[] linea = null;
            try {
                while ((linea = origen.readNext()) != null) {
                    MovimientosCrédito.add(new MovimientoCrédito(Integer.parseInt(linea[0]), Integer.parseInt(linea[1]), Integer.parseInt(linea[2]), linea[3]));
                }
            } catch (IOException | CsvValidationException ex) {
                Logger.getLogger(CrearMovimientoCrédito.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        try {
            origenCrédito = new CSVReader(new FileReader("creditos.csv"));
            String[] linea = null;
            try {
                while ((linea = origenCrédito.readNext()) != null) {
                    comboIdCredito.addItem(linea[0]);
                }
            } catch (IOException | CsvValidationException ex) {
                Logger.getLogger(CrearMovimiento.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        for (MovimientoCrédito tipo : MovimientosCrédito) {
            if(lastId < tipo.getIdMovxCredito()) {
                lastId = tipo.getIdMovxCredito();
            }
        }
    ...
    private void initComponents() {
        ...
        comboIdCredito = new javax.swing.JComboBox<>();
        IdCredito = new javax.swing.JLabel();
        ...
        comboIdCredito.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboIdCreditoActionPerformed(evt);
            }
        });

        IdCredito.setText("Crédito");
                ...
                .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanelLayout.createSequentialGroup()
                        .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(comboIdCredito, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(comboIdMovimiento, 0, 630, Short.MAX_VALUE))
                        .addGap(20, 20, 20))
                    .addGroup(PanelLayout.createSequentialGroup()
                        .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(IdMovimiento)
                            .addComponent(IdCredito))
        ...
        PanelLayout.setVerticalGroup(
            ...
            .addGroup(PanelLayout.createSequentialGroup()
                ...
                .addComponent(IdCredito)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(comboIdCredito, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(9, 9, 9)
                .addComponent(status)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btnCrear.setText("Crear movimiento crédito");
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if(comboIdCredito.getModel().getSelectedItem().equals("") || comboIdMovimiento.getModel().getSelectedItem().equals("")) {
            ...
            String IdCredito = (String)comboIdCredito.getSelectedItem();
            ...
            MovimientosCrédito.add(new MovimientoCrédito(lastId + 1, Integer.parseInt(idMovimiento), Integer.parseInt(IdCredito), statusId));
            
            try {
                CSVWriter destino = new CSVWriter(new FileWriter("mvxcreditos.csv", false));
                ...
                JOptionPane.showMessageDialog(null, "El movimiento de crédito se ha guardado exitosamente");
    ...
    private void comboIdCreditoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboIdCreditoActionPerformed
    }//GEN-LAST:event_comboIdCreditoActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel IdCredito;
    private javax.swing.JLabel IdMovimiento;
    private javax.swing.JPanel Panel;
    private javax.swing.JLabel Título;
    private javax.swing.JButton btnCancelar;
    private javax.swing.JButton btnCrear;
    private javax.swing.JComboBox<String> comboIdCredito;
